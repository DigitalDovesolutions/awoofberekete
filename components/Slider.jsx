    ...
    const items = [
        {
            text: "Welcome to",
            name: "Awoof Berekete",
            content: "Indulge in a culinary journey where every dish is crafted to perfection. Experience the finest ingredients, exceptional flavors, and a dining experience like no other.",
            button: {
                primary: "Menu",
                secondary: "Order Now"
            },
...

        {
            text: "Showcae to",
            name: "Awoof",
            content: "Indulge in a culinary journey where every dish is crafted to perfection. Experience the finest ingredients, exceptional flavors.",
            button: {
                primary: "Menu",
                secondary: "Order Now"
            },
  ...
  return (
    <>
       <Carousel className="w-screen lg:py-16">
            <CarouselContent>
                {items.map(({text, name, content, button, image, icons}) => (
                            ...
                            <CardContent className="flex max-[991px]:p-[3rem_0_3rem_0] max-[991px]:flex-col aspect-video items-center justify-between text-start px-0 pb-[40px] pt-[67px]">
                                    ...
                                    <div className="d-table-cell">
                                        <div className="content lg:max-w-[500px]">
                                            <span className="relative min-[991px]:pl-1 mb-3 flex items-center max-[991px]:justify-center py-2">
                                                <h6 className="mb-0 text-[20px] font-semibold text-danger pl-1">{text}</h6>
                                            </span>
                                            <h1 className="mb-3 lg:text-[55px] max-[767px]:text-[35px] font-bold text-dark">{name}</h1>
                                            ...
                                            <div className="socials flex max-[991px]:justify-center">
                                                <div className="socials__items flex items-center gap-6">
                                                    {icons.map((IconComponent, idx) => (
                                                        <a key={idx} href="/" className="border-[1.5px] border-primary p-3 rounded-full max-[991px]:p-2 hover:bg-primary hover:text-white transition-colors duration-150">
                                ...
                                <div className="right-content">
                                    <div className="relative image">
                                        ...
                                        <Image
                                        className="z-20 max-lg:w-[80%] max-lg:mx-auto"
                                        src={image.primary}
                                        ...
                                        <Image
                                            className="max-lg:w-[55%] max-sm:w-[50px]"
                                            src={Leaf}
                                            alt="Dish"
                                            width={100}
                                            loading="lazy"
